...
ただし初見ユーザーに対しては、抽象的な世界観より先に「ここはAllNewアプリの改善要望と新アプリ案を送る場所」と明確に伝える。トップの最初に Welcome first セクションを置き、用途、対象、投稿できる内容、2つの行動（投稿する / 公開ボードを見る）を数秒で理解できるようにする。
...
|---|---|---|---|
| Home | 入口。何ができるかを即時理解 | アイデアを投稿する | 公開ボードを見る |
...
Home は説明ページではなく、操作ハブにする。ただし最上部だけは、初めて訪れた人が「自分に関係があるサイトだ」と分かる Welcome first セクションにする。

優先順位:

1. Brand and menu
2. Welcome first: 何の場所か、何を投稿できるか、投稿する / 公開ボードを見る
3. Target apps carousel
4. Support tools
5. 今週のひらめき
6. アイデアの旅
...
- Kicker: AllNew App Factory へようこそ
- Main: あなたの「あったらいいな」を、アプリの次の一歩へ。
- Support: このサイトは、AllNewのアプリをもっと使いやすく育てるためのアイデア共有スペースです。不具合、改善要望、新しいアプリ案を、メモ感覚で気軽に送れます。
- CTA: アイデアを投稿する / 公開ボードを見る
