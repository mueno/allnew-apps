...
const APP_DATA = {
    ...
    pupweight: {
        ...
        ja: {
            ...
            description: "体重計の表示をカメラで読み取り、ペットの体重を記録するアプリ",
            dataTypes: "ペットの体重データ",
            ...
            appOverview: "体重計の表示をカメラで撮影し、画像認識（OCR）によりペットの体重値を読み取り、端末内に記録する機能を提供します。",
        ...
        en: {
            ...
            description: "Reads scale displays via camera to record your pet's weight",
            ...
            appOverview: "The App captures a photo of your scale display, uses OCR to read your pet's weight, and stores it on your device.",
