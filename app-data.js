...
const APP_DATA = {
    ...
    oxisnap: {
        ...
        ja: {
            subtitle: "SpO2記録アプリ",
            description: "パルスオキシメーターに表示されたSpO2値を音声で入力し、Apple HealthKit（ヘルスケア）に記録するアプリ",
            dataTypes: "SpO2（酸素飽和度）データ",
            healthKitWrite: "SpO2データの書き込み",
            healthKitRead: "SpO2データの読み取り（前回比表示、推移グラフ等）",
            cameraUsage: "",
            importantNote: "本アプリは、SpO2データを当社の外部サーバーに送信・保存しません。音声認識はApple SFSpeechRecognizerによるオンデバイス処理で、音声データは認識後に即時破棄されます。SpO2データは端末内およびApple HealthKitに保存されます。",
            appOverview: "パルスオキシメーターに表示されたSpO2値を音声で読み上げ、音声認識によりApple HealthKitに記録する機能を提供します。",
            appOverview2: "ユーザーが任意に許可した場合に限り、ヘルスケア上のSpO2データを読み取り、推移表示等に利用します。",
            supportedDevices: "<strong>入力方法:</strong> パルスオキシメーターの表示値を声で読み上げるだけでSpO2を記録できます。",
        ...
        en: {
            ...
            description: "Say your SpO2 reading aloud to record it in Apple HealthKit",
            ...
            cameraUsage: "",
            importantNote: "This app does not send or store your SpO2 data on our external servers. Speech recognition is performed on-device by Apple SFSpeechRecognizer, and voice data is discarded immediately after recognition.",
            appOverview: "The App lets you say your pulse oximeter SpO2 reading aloud. Speech recognition captures the value and records it to Apple HealthKit.",
            appOverview2: "If you optionally grant read access, the App may also read your SpO2 data to show changes and trends.",
            supportedDevices: "<strong>Input Method:</strong> Just say your pulse oximeter reading aloud to record your SpO2.",
